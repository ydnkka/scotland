...
def fit_bambi_model(
        ...
        run_id: int | str,
        *,
        dependent: str = "n_sequences_shifted",
    ...
    Args:
        ...
        family: The likelihood family (e.g., 'negativebinomial', 'poisson', 'gaussian').
    ...
    trace_path = os.path.join(save_dir, f"{run_id}_bambi_trace.nc")
    formula_path = os.path.join(save_dir, f"{run_id}_bambi_formula.json")
    summary_path = os.path.join(save_dir, f"{run_id}_bambi_summary.csv")
