...
`cluster_characterisation.py` builds cluster aggregates that extend the
Part 1 cluster table with vaccination and SIMD-domain variables.
...
### 6.3 Parquet caches (part2/cache/)
...
### 6.4 Manuscript figures (part2/manuscript/figures/)
