...
Run one model version:
    python -m analyses.sse_detection.lib.model.composition --family linear --outcome burden_score --model-set expanded
"""
...
if __package__ in {None, ""}:
    ...
    from analyses.sse_detection.lib.model.runner import main_for_domain
else:
