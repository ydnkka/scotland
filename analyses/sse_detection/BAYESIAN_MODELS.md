...
```bash
python -m analyses.sse_detection.lib.model.mixing --list-models
python -m analyses.sse_detection.lib.model.composition --list-models
```

Inspect formulas and fit-frame sizes without fitting:

```bash
python -m analyses.sse_detection.lib.model.mixing --dry-run --family logistic --model-set null_primary
python -m analyses.sse_detection.lib.model.composition --dry-run --family linear --outcome burden_score --model-set expanded
```

Fit selected models:

```bash
python -m analyses.sse_detection.lib.model.mixing --family logistic --model-set observed_expanded
python -m analyses.sse_detection.lib.model.composition --family linear --outcome burst_score --model-set primary
```
