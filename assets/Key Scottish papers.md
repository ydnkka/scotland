...
Research on the impact of superspreading events (SSEs) in Scotland remains comparatively sparse. Although Scotland has contributed important genomic and outbreak-focused studies on SARS-CoV-2 introductions, transmission in specific high-risk settings, and variant spread, very few published papers place SSEs themselves at the centre of analysis or explicitly quantify their epidemiological impact. Instead, the Scottish literature has tended to focus on early importations, institutional outbreaks such as those in hospitals, care homes, dialysis units and universities, or broader questions of lineage replacement and policy, with superspreading usually treated implicitly rather than as a distinct analytic framework. As a result, compared with the wider international literature on transmission heterogeneity and SSEs, there is still limited Scotland-specific evidence on how superspreading shaped epidemic growth, cluster size distributions, or social inequalities in transmission across different phases of the pandemic.
