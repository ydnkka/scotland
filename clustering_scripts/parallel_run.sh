...
#
# Usage:
#   ./clustering_scripts/parallel_run.sh -c data/processed/group_fastas/tn93_commands.txt
#   ./clustering_scripts/parallel_run.sh -c <commands.txt> -j 16 --progress
#   ./clustering_scripts/parallel_run.sh -c <commands.txt> --retries 2 --resume-failed
