...
def plot_policy_report(
    ...
    policy_category_summary: pd.DataFrame | str | Path | Any,
    ...
    *,
    ...
    category_mix = _prepare_category_mix(_read_table(policy_category_summary))
...
def make_policy_figures(
    *,
    ...
    fig = plot_policy_report(
        ...
        results_path / "policy_era_category_summary.csv",
