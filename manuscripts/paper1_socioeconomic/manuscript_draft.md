# Socioeconomic deprivation and SARS-CoV-2 genomic transmission clustering in Scotland: an EpiLink-based analysis of national surveillance data
...
## Table 1. Key adjusted cluster-size associations
...
| Epoch | OR for Q1 vs Q5 | 95% CI | Interpretation |
| --- | ---: | --- | --- |
| Pre-VOC | 0.470 | 0.396-0.558 | Q1 much less likely than Q5 to be a singleton |
| Alpha | 0.372 | 0.328-0.420 | Strong deprivation gradient |
| Delta | 0.436 | 0.415-0.458 | Persistent deprivation gradient |
| Omicron BA.1 | 0.385 | 0.356-0.418 | Gradient persists despite lower sequencing coverage |
| Omicron BA.2+ | 0.376 | 0.358-0.394 | No meaningful attenuation during late Omicron |
