...
Run from the Scotland repository root:
    ...
    python -m observation_networks.build_sensitivity_tables

For a quick development check:

    python -m observation_networks.build_sensitivity_tables --max-windows 3 \
        --max-files 10
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=TABLES_DIR,
        help="Output table directory. Default: observation_networks/results/tables.",
    )
    parser.add_argument(
        "--baseline-resolution",
        type=float,
