"""Build publication figures into the top-level results directory."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=FIGURES_DIR,
        help="Directory for generated top-level figures.",
    )
    parser.add_argument(
        "--table-dir",
        type=Path,
        default=TABLES_DIR,
        help="Directory for figure companion tables generated by some builders.",
    )
    parser.add_argument(
        "--skip-missing",
        action="store_true",
    ...
    parser.add_argument(
        "--list",
        action="store_true",
        help="List available figure builders and exit.",
    )
    parser.add_argument(
        "--log-level",
        default="INFO",
...
def main() -> int:
    ...
    if args.list:
        print(list_builders(figure_builders(), domains=args.domain))
        return 0
