...
Usage:
  python3 clustering_scripts/04_gen_cluster_commands.py
  python3 clustering_scripts/04_gen_cluster_commands.py --config config.yaml --root /path/to/repo
"""
...
def main() -> int:
    ...
    script = args.root / "clustering_scripts" / "03_process_group.py"
