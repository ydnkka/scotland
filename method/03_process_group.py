...
def setup_logging(level: str = "INFO") -> None:
    """Configure timestamped console logging for one group-processing run."""
    logging.basicConfig(
...
def parse_group_label(stem: str) -> tuple[str, str]:
    """Extract window ID and lineage label from a group file stem.

    Always returns two strings (may be empty) to avoid passing None to
    downstream functions that expect str.
    """
...
def process_group(
    ...
    """Convert one TN93 distance file into Leiden cluster assignments."""
...
def main() -> int:
    """Parse CLI arguments and process one window-lineage group."""
